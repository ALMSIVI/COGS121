...
db.serialize(() => {
  ...
  db.run("CREATE TABLE score (username TEXT NOT NULL, score INTEGER NOT NULL, song_title TEXT COLLATE NOCASE, song_artist TEXT COLLATE NOCASE, FOREIGN KEY (username) REFERENCES account(username), FOREIGN KEY (song_title, song_artist) REFERENCES songs_to_lyrics(title, artist))");
  ...
  db.run("INSERT INTO score VALUES ('admin', 50, 'Hirugohan', 'Gundam')");
  db.run("INSERT INTO score VALUES ('admin', 100, 'Hirugohan', 'Gundam')");
  db.run("INSERT INTO score VALUES ('admin', 300, 'Hirugohan', 'Gundam')");
  db.run("INSERT INTO score VALUES ('admin', 40, 'Hirugohan', 'Gundam')");
